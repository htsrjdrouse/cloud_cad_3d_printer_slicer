...
system("jscad uploads/".$jscadfile." -o uploads/rendered_".$_SESSION['objectsactive']);
...
system("jscad uploads/".$jscadfile." -o uploads/rendered_".preg_replace("/.jscad$/", ".stl", $_SESSION['jscadfilename']));

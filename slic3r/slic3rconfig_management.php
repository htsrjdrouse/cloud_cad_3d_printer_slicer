...
?>
<?
if (!isset($_SESSION['slic3rconfig'])){$_SESSION['slic3rconfig'] = $slic3rconfig;}
//$_SESSION['slic3rconfig'] = $slic3rconfig;
$_SESSION['varname'] = $varname;
$_SESSION['varheader'] = $varheader;
?>
...
<button type="submit" name="deleteconfig" class="btn-sm btn-danger">Delete</button><br><br>
<br><br>
...
$myfile = fopen($_SESSION['configactive'].".ini", "r");
$contents = fread($myfile, filesize($_SESSION['configactive'].".ini"));
?>
...
<b><? slicer_accord($varname,$varheader,$_SESSION['slic3rconfig']); ?></b>

<br><? //var_dump($slic3rconfig);?><br>
<br>

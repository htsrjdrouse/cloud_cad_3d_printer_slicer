...
<br>
  <button type="submit" name="selectopenscad" class="btn-sm btn-primary"><b>Select file</b></button>&nbsp;&nbsp;
...
<br>
<form action="openscad.objects.json.form.php" method="post" enctype="multipart/form-data">
 <style>
.fileContainer {
    overflow: hidden;
    position: relative;

...
<!--<script src="<?=$path?>openjscad.js?0.5.1<?=date('l jS \of F Y h:i:s A'); ?>"></script> -->

<? include('openjscad.php');?>
...
<!--<script language="javascript" src="/jscad-web.min.js"></script>-->
...
<div onload="$(this).loadProcessor()"></div>
  ...
  <div class="jscad-container">
    ...
    <? if (!isset($_SESSION['jscadfilename'])){ ?> 
     <font color=red>Please select a CAD file</font><br>
    <? } else { ?> 
      <div id="errordiv"></div>
    <? } ?>
    </div>
